...
class __TwigTemplate_132b0268f98efa69c6facbb026e1449c extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo "Administration des categories";
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        <section class=\"row\">
            <div class=\"col-12\">
                ...
                ";
        // line 10
        $this->loadTemplate("admin/categories/_form.html.twig", "admin/categories/edit.html.twig", 10)->display(twig_array_merge($context, ["button_label" => "Modifier"]));
        // line 11
        echo "            </div>
        </section>
    </main>
...
{% block title %}Administration des categories{% endblock %}
...
{% block body %}
    <main class=\"container\">
        <section class=\"row\">
            <div class=\"col-12\">
                <h1>Modifier une categorie</h1>
                {% include \"admin/categories/_form.html.twig\" with {'button_label': 'Modifier'} %}
            </div>
        </section>
    </main>
{% endblock %}
...
", "admin/categories/edit.html.twig", "/Applications/MAMP/htdocs/biblioteckSymfony/templates/admin/categories/edit.html.twig");
    }
}
