...
class getMainControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Controller/Admin/MainController.php';

        $container->services['App\\Controller\\Admin\\MainController'] = $instance = new \App\Controller\Admin\MainController();

        $instance->setContainer(($container->privates['.service_locator.CshazM0'] ?? $container->load('get_ServiceLocator_CshazM0Service'))->withContext('App\\Controller\\Admin\\MainController', $container));
